...
async def sync_orders(
    status: Optional[str] = Query(None, description="Order status filter (processing, completed, etc.)"),
    since_days: Optional[int] = Query(None, description="Only sync orders from last N days"),
